...
PRIMARY_SERVICE(service_heart_rate, gBleSig_HeartRateService_d)
    CHARACTERISTIC(char_hr_measurement, gBleSig_HrMeasurement_d,  (gGattCharPropRead_c) | (gGattCharPropWrite_c) | (gGattCharPropNotify_c))
        VALUE_VARLEN(value_hr_measurement, gBleSig_HrMeasurement_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 22, 2, 0x00, 0xB4)
